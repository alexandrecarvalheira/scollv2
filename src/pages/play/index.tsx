...
export default function Play() {
  ...
  return (
    <div className="relative w-fit min-h-min flex items-center justify-center overflow-hidden  mx-auto">
      <Image src={map2} alt="game map" width="1000" className="rounded-3xl" />
      <PlayerCard />
